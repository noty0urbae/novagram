...
<nav class="bg-white border-gray-200">
    ...
    <div class="flex flex-col lg:flex-row gap-3 max-w-md mx-auto px-8 justify-center">
        <a href="#" class="flex-1">
            <button onclick="copyToClipboard()" class="w-full text-white bg-red-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center lg:mb-0">Copy</button>
        </a>
        <a href="<?php echo base_url('auth/dashboard'); ?>" class="flex-1">
            <button class="w-full py-2.5 px-3 me-2 mb-2 lg:mb-0 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-black-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700">Back</button>
        </a>
        <a href="<?php echo base_url('authguest/guestlogin'); ?>" class="flex-1">
            <button class="w-full py-2.5 px-3 me-2 mb-2 lg:mb-0 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-black-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700">Guest</button>
        </a>
    </div>
