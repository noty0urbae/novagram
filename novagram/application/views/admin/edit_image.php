        ...
        <div class="w-full bg-white rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <img src="<?php echo base_url('assets/upload/' . $image->gambar); ?>" class="max-h-full max-w-auto rounded-lg" alt="<?php echo $image->judul; ?>">
                    ...
                    <button type="submit" class="w-full text-white bg-red-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-5">Save</button>
                    <?php echo form_close(); ?>
                    <a href="<?php echo base_url('dashboard/view_image/' . $image->gambar); ?>">
                        <button class="w-full py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-black-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 mt-3">Back</button>
                    </a>
                </form>
            </div>
        </div>
