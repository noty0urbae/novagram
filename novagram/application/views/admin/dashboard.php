...
<body>
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <img class="h-8" src="<?php echo base_url('assets/brand/logo.jpg'); ?>" alt="logo">
            ...
            <ul class="font-medium flex md:flex md:items-center p-4 md:p-0 mt-4 border border-gray-200 rounded-lg bg-white space-x-2 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white">
                <li>
                    <a href="<?php echo base_url('dashboard/profile'); ?>">
                        <button type="button" class="w-full md:max-w-xs text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 text-center">Profile</button>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url('auth/logout'); ?>">
                        <button type="button" class="w-full md:max-w-xs text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 text-center">Log out</button>
                    </a>
                </li>
            </ul>
        </div>
...
<!--
    <form action="" method="post" class="mb-4">
        <div class="relative w-full">
            ...
            <input type="text" id="search" name="search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full ps-10 p-2.5 placeholder-gray-400" placeholder="Search for images by title..." required>
        </div>
...
-->   
    ...
    <a href="<?php echo base_url('dashboard/add_data'); ?>">
        <button type="button" class="fixed bottom-8 left-1/2 transform -translate-x-1/2 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xl px-5 py-2.5 text-center inline-flex items-center" style="box-shadow: 0 20px 25px -5px rgb(0 0 0 / 0.2), 8px 8px 10px -6px rgb(0 0 0 / 0.2);">
