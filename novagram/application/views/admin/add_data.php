            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <?php echo form_open('dashboard/add_data', array('method' => 'post', 'class' => 'space-y-4 md:space-y-6', 'enctype' => 'multipart/form-data')); ?>
                    ...
                    <div class="flex flex-row gap-3 ">
                        <button type="submit" class="mb-3 flex-1 h-full w-full text-white bg-red-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center">Add images</button>
                    </div>
                <?php echo form_close(); ?>
                    <a href="<?php echo base_url('auth/dashboard'); ?>" class="flex-1">
                        <button class="flex-1 h-full w-full py-2.5 px-4 me-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-black-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700">Back</button>
                    </a>
            </div>
        </div>
    </div>
